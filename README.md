...
> Composable components for easy use of Google Maps with Vue 3 (Modified by Chahin)

`@chahindb7vue3-google-maps` offers a set of composable components for easy use of Google Maps in your Vue 3 projects.
...
```bash
npm install @chahindb7vue3-google-maps
# OR
pnpm add @chahindb7vue3-google-maps
```
...
```html
<script src="https://unpkg.com/@chahindb7vue3-google-maps"></script>
```
...
```vue
<script setup>
import { GoogleMap, Marker } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, AdvancedMarker } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, Polyline } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, Polygon } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, Rectangle } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, Circle } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, InfoWindow } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, Marker, InfoWindow } from '@chahindb7vue3-google-maps'
        ...
        <div id="content">
          ...
          <div id="bodyContent">
            <p>
              ...
              450&#160;km (280&#160;mi) by road. Kata Tjuta and Uluru are the two major features of
              the Uluru - Kata Tjuta National Park. Uluru is sacred to the Pitjantjatjara and
...
```vue
<script setup>
import { GoogleMap, CustomMarker } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, CustomControl } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, Marker, MarkerCluster } from '@chahindb7vue3-google-maps'
...
```vue
<script setup>
import { GoogleMap, HeatmapLayer } from '@chahindb7vue3-google-maps'
...
The basic components that `@chahindb7vue3-google-maps` provides are fully reactive and will get you pretty far. Should you need to access the Google Maps API, however, the `GoogleMap` component exposes the following:
...
import { GoogleMap } from '@chahindb7vue3-google-maps'
